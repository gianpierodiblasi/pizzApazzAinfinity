...
public class Z4CanvasGridPanel extends JSDropDown {
  ...
  private final JSLabel xLabel = new JSLabel();
  private final JSLabel yLabel = new JSLabel();
  ...
  private final JSComponent vline3;
   ...
   */
  public void reset(int width, int height, boolean resetOnlySize) {
    double value;
    ...
    this.plotWidthSlider.setValue((int) value);
