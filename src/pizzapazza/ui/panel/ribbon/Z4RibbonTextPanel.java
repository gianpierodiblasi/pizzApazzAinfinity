...
public class Z4RibbonTextPanel extends Z4AbstractRibbonPanel {
  ...
  public Z4RibbonTextPanel() {
    ...
    this.addDropDown("z4ribbontextpanel-shearing", Z4Translations.SHEARING, this.textShearX, this.textShearY, x + 3, 5);
    ...
    this.addDropDown("z4ribbontextpanel-offset", Z4Translations.OFFSET, this.shadowOffsetX, this.shadowOffsetY, x + 2, 5);
    this.addDropDown("z4ribbontextpanel-shearing", Z4Translations.SHEARING, this.shadowShearX, this.shadowShearY, x + 3, 0);
    Z4UI.addVLine(this, new GBC(x + 4, 0).h(6).wy(1).f(GBC.VERTICAL).i(1, 2, 1, 2));
  ...
  private void addDropDown(String dropDownContentSelector, String title, JSSpinner xSpin, JSSpinner ySpin, int x, int right) {
    ...
    this.add(dropDown, new GBC(x, 2).h(2).f(GBC.VERTICAL).i(0, 0, 0, right));
  }
