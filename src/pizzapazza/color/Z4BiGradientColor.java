...
/**
 * The bidimensional gradient color (a bidimensional gradient between four or more colors)
 *
 * @author gianpiero.diblasi
 */
public class Z4BiGradientColor {

  private final Array<Z4GradientColor> gradientColors = new Array<>();
  private final Array<Double> gradientColorPositions = new Array<>();
...
//    this.addColor(new Color(0, 0, 0, 255), 1, 1);
   ...
   */
  public void addColor(Color color, double x, double y) {
...
//    }
   ...
   * @param y The y-axis coordinate (in the range [0,1])
   */
  public void removeColor(double x, double y) {
//    int index = this.colorPositions.findIndex(point -> point.x == x && point.y == y);
//
//    if (index != -1) {
...
//    }
   ...
   */
  public boolean isPositionOccupied(double x, double y, double tolerance) {
//    return $exists(this.colorPositions.filter(point -> Math.abs(point.x - x) <= tolerance && Math.abs(point.y - y) <= tolerance).length);
  ...
  public Z4Point getPosition(double x, double y, double tolerance) {
...
//    }
   ...
   */
  public void setRipple(double rippleX, double rippleY) {
   ...
   * @return The Color
   */
  public Color getColorAt(double x, double y, boolean useRipple) {
