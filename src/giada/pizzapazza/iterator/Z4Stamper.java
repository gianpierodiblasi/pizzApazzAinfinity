...
public class Z4Stamper extends Z4PointIterator<Z4Stamper> {
  ...
  private Z4FancifulValue intensity = new Z4FancifulValue().setConstant(Z4Sign.POSITIVE, 15);
  private Z4FancifulValue multiplicity = new Z4FancifulValue().setConstant(Z4Sign.POSITIVE, 1);
  private Z4FancifulValue push = new Z4FancifulValue();
