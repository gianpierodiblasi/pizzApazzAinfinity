...
import giada.pizzapazza.painter.ui.Z4CenteredFigurePainterUI;
...
public class test_centered_figure {
  ...
  public static void onLoad() {
    ...
    Z4CenteredFigurePainterUI ui = new Z4CenteredFigurePainterUI().appendToElement(document.getElementById("test1"));
    ui.oninput = (value) -> document.getElementById("test2").textContent = "ONINPUT " + test_centered_figure.stringify(value);
    ui.onchange = (value) -> document.getElementById("test2").textContent = "ONCHANGE " + test_centered_figure.stringify(value);
    document.getElementById("test2").textContent = test_centered_figure.stringify(ui.getValue());
