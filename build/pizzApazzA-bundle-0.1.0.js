...
class Z4BiGradientColorPanel extends JSPanel {
  ...
  constructor() {
    ...
    this.addComponent(this.preview, 0, 0, 3, 2, 0, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, null);
    this.addLabel(Z4Translations.RIPPLE, 3, 1, 1, 1, GridBagConstraints.SOUTH, GridBagConstraints.NONE);
    ...
    this.addComponent(this.biRippleSpinner, 3, 0, 1, 1, 0, 0, GridBagConstraints.NORTHEAST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0));
    ...
    this.addComponent(this.biRippleSlider, 4, 0, 1, 2, 0, 0, GridBagConstraints.EAST, GridBagConstraints.NONE, null);
    this.colorPreview.setColor(this.biGradientColor.getColorAtIndex(0).getColorAtIndex(0));
    this.addComponent(this.colorPreview, 0, 2, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, null);
    let button = new JSButton();
    button.setText(Z4Translations.EDIT);
    button.addActionListener(event => this.selectColor());
    this.addComponent(button, 1, 2, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0));
    ...
    this.addComponent(this.delete, 2, 2, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 5, 0, 0));
