...
/**
 * The drawing mode of a Z4Tracer
 *
 * @author gianpiero.diblasi
 */
class Z4TracerDrawingMode {
...
class Z4Canvas extends JSComponent {
   ...
   */
   setRulers(showTopRuler, showBottomRuler, showLeftRuler, showRightRuler, topRulerPosition, bottomRulerPosition, leftRulerPosition, rightRulerPosition) {
...
class Z4GeometricShapePreview extends JSDropDown {
  ...
  constructor() {
    ...
    button.addActionListener(event => {
      let newShape = this.shape.fromResize(this.canvas.getSize().width, this.canvas.getSize().height);
...
class Z4Tracer extends Z4PointIterator {
   ...
   * @param rotation The rotation
   */
  constructor(multiplicity, push, attack, sustain, release, endlessSustain, step, drawingMode, rotation) {
    super(rotation);
    this.multiplicity = multiplicity;
    this.push = push;
    this.attack = attack;
   ...
   */
   ...
   drawAction(action, progression, x, y) {
    if (action === Z4PointIteratorDrawingAction.START) {
      ...
      } else if (this.drawingMode === Z4TracerDrawingMode.ASSISTED && distance >= 10) {
      ...
      } else if (this.drawingMode === Z4TracerDrawingMode.RULER) {
        this.reset(progression);
   ...
   toJSON() {
    ...
    json["drawingMode"] = this.drawingMode;
    return json;
  }
...
/**
 * The orientation used to color each character of a text
 *
 * @author gianpiero.diblasi
 */
class Z4TextInfoTextColorOrientation {
