...
class test_signedrandomvalue1 {
  ...
  static  onLoad() {
    ...
    let ui2 = new Z4SignedRandomValueUI().setRange(30, 80, true).setValueLabel("INTENSITY", true, true).setValue(Z4SignedRandomValue.bezier(40, 10).setSign(Z4Sign.NEGATIVE)).appendToElement(document.querySelector("#test3"));
    let ui3 = new Z4SignedRandomValueUI().setCompact().setRange(0, 1000, true).setValueLabel("INTENSITY", true, true).setValue(Z4SignedRandomValue.bezier(40, 10).setSign(Z4Sign.NEGATIVE)).appendToElement(document.querySelector("#test5"));
