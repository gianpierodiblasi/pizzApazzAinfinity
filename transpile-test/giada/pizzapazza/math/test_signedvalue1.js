...
class test_signedvalue1 {
  ...
  static  onLoad() {
    ...
    let ui2 = new Z4SignedValueUI().setRange(30, 80).setValueLabel("INTENSITY", true, true).setValue(new Z4SignedValue().setSign(Z4Sign.NEGATIVE).setValue(50));
    ui2.appendToElement(document.querySelector("#test3"));
    let ui3 = new Z4SignedValueUI().setRange(30, 80).setValueLabel("INTENSITY", true, true).compact().setValue(new Z4SignedValue().setSign(Z4Sign.NEGATIVE).setValue(50));
