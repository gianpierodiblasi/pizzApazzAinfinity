...
class test_color3 {
  ...
  static  onLoad() {
    ...
    let ui2 = new Z4ProgressionUI().setProgressionLabel("INTENSITY", true, true).setValue(Z4Progression.temporal(0.3, Z4Lighting.LIGTHED)).appendToElement(document.querySelector("#test3"));
