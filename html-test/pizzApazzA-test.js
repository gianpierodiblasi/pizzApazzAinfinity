 ...
 * @author gianpiero.diblasi
 */
class TestBiGradientColorProgressingPanel extends JSFrame {
  ...
  constructor() {
    ...
    let disabled = new Z4BiGradientColorProgressionPanel(Z4GradientColorProgressionPanelOrientation.HORIZONTALLY_COMPACT);
    ...
    let lighted = new Z4BiGradientColorProgressionPanel(Z4GradientColorProgressionPanelOrientation.HORIZONTALLY_COMPACT);
...
class TestFancifulValuePanel extends JSFrame {
  ...
  constructor() {
    ...
    p.add(new Z4FancifulValuePanel(Z4FancifulValuePanelOrientation.HORIZONTALLY_VERTICAL), new GBC(0, 1).wx(1).i(5, 5, 5, 5));
    labelled = new Z4FancifulValuePanel(Z4FancifulValuePanelOrientation.HORIZONTALLY_VERTICAL);
    labelled.setLabel("Label");
    labelled.cssAddClass("z4abstractvaluepanel-titled");
    p.add(labelled, new GBC(1, 1).wx(1).i(5, 5, 5, 5));
    p.add(new Z4FancifulValuePanel(Z4FancifulValuePanelOrientation.HORIZONTAL), new GBC(0, 2).w(3).i(5, 5, 5, 5));
    labelled = new Z4FancifulValuePanel(Z4FancifulValuePanelOrientation.HORIZONTAL);
    labelled.setLabel("Label");
    labelled.cssAddClass("z4abstractvaluepanel-titled");
    p.add(labelled, new GBC(0, 3).w(3).i(5, 5, 5, 5));
...
class TestRandomValuePanel extends JSFrame {
  ...
  constructor() {
    ...
    let disabled = new Z4RandomValuePanel(Z4RandomValuePanelOrientation.HORIZONTAL);
    disabled.setEnabled(false);
    ...
    let valued = new Z4RandomValuePanel(Z4RandomValuePanelOrientation.HORIZONTAL);
    valued.setLabel("Valore");
    ...
    let signedValue = new Z4SignedRandomValuePanel(Z4RandomValuePanelOrientation.HORIZONTAL);
