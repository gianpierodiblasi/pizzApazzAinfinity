...
class TestFancifulValuePanel extends JSFrame {
  ...
  constructor() {
    ...
    let labelled = new Z4FancifulValuePanel(Z4FancifulValuePanelOrientation.HORIZONTAL);
    ...
    let disabled = new Z4FancifulValuePanel(Z4FancifulValuePanelOrientation.HORIZONTAL);
